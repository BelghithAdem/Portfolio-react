export const portfolioDataEn = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: [
        "Complete WordPress e-commerce site with advanced SEO optimization.",
        "Secure payment integration, inventory management and analytics.",
        "Optimized performance, responsive design and natural referencing."
      ]
    },
    {
      name: "Dhiya Store",
      ...
      category: "professional",
      description: [
        "WordPress online store specialized in pottery and decoration.",
        "Complete catalog with pots, mugs, plates and decorative objects.",
        "Custom ordering system and integrated pottery courses."
      ]
    },
    {
      name: "Quran App",
      ...
      category: "academic",
      description: [
        "Modern web application for Quran reading.",
